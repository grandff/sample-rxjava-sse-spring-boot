...
public class BookController {
    ...
    public Single<ResponseEntity<BaseResponse<?>>> addBook(@RequestBody AddBookRequestDto addBookRequestDto) {
        return bookService.addBook(addBookRequestDto).subscribeOn(Schedulers.io()).map(
                s -> ResponseEntity.created(URI.create("/api/book/" + s)).body(BaseResponse.actionCreateSuccess()));
    }
    ...
    public Single<ResponseEntity<BaseResponse<?>>> updateBook(@RequestBody UpdateBookRequestDto updateBookRequestDto,
